 ...
 */
public class CGA4Multivector implements iCGAMultivector {
    
    MatrixSparsity sparsity; 
    DM dm; 
    ...
    //static CGA4Multivector defaultInstance = new CGA4Multivector(0,0d);
         
    // creation of a default instance
    public CGA4Multivector(){}
    
    /*CGA4Multivector(de.orat.math.cga.impl2.generated.CGA cga){
        super(cga._mVec);
    }*/
    
    public CGA4Multivector(int idx, double value){
    ...
    @Override
    public CGA4Multivector op(iCGAMultivector b){
        return new CGA4Multivector(binop_Wedge(this, (CGA) b));
    }
     ...
     * @return vee product
     */
    public CGA4Multivector vee(CGA4Multivector b){
        return new CGA4Multivector(binop_Vee(this,b));
    }
     ...
     */
    public CGA4Multivector ip(iCGAMultivector b){
        return new CGA4Multivector(CGA.binop_Dot(this, (CGA) b));
    }
    /**
     * Dual operation.
     * 
     ...
     */
    @Override
    public CGA4Multivector dual(){
        return new CGA4Multivector(CGA.unop_Dual(this));
    }
     ...
     */
    @Override
    public CGA4Multivector conjugate(){
        return new CGA4Multivector(super.Conjugate());
    }
     ...
     */
    @Override
    public CGA4Multivector reverse(){
        return new CGA4Multivector(unop_Reverse(this));
    }
     ...
     */
    @Override
    public CGA4Multivector gradeInversion(){
         return new CGA4Multivector(super.Involute());
    }
     ...
     */
    @Override
    public CGA4Multivector extractGrade(int grade){
        if (grade > 5 || grade < 0) 
        ...
        return new CGA4Multivector(result);
    }
    ...
    public iCGAMultivector generalInverse(){
        CGA4Multivector conjugate = conjugate();
        CGA4Multivector gradeInversion = gradeInversion();
        CGA4Multivector reversion = reverse();
        CGA4Multivector part1 = (CGA4Multivector) conjugate.gp(gradeInversion).gp(reversion); 
        CGA4Multivector part2 = (CGA4Multivector) gp(part1); 
        CGA4Multivector part3 = negate14(part2);
     ...
     */
    private CGA4Multivector negate14(CGA4Multivector m){
        ...
        return (CGA4Multivector) create(coordinates);
    }
    ...
    public iCGAMultivector add(iCGAMultivector b) {
         return new CGA4Multivector (binop_Add (this, (CGA4Multivector) b));
    }
    @Override
    public iCGAMultivector add (double b){
        return new CGA4Multivector (binop_adds (this, b));
    }
    @Override
    public iCGAMultivector sub (iCGAMultivector b){
        return new CGA4Multivector (binop_Sub (this, (CGA4Multivector) b));
    }
    @Override
    public iCGAMultivector sub (double b){
        return new CGA4Multivector (binop_subs (this, b));
    }
    @Override
    public iCGAMultivector gp(iCGAMultivector b){
        return new CGA4Multivector(binop_Mul(this, (CGA4Multivector) b));
    }
    @Override
    public iCGAMultivector gp(double s){
        return new CGA4Multivector(binop_smul (s, this));
    }

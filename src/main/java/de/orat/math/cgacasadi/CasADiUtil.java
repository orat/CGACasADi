...
public class CasADiUtil {
    ...
    public static MX toMXProductMatrix(SparseCGASymbolicMultivector mv, CGACayleyTable cgaCayleyTable){
        ...
        double[][] zeros = new double[mv.getBladesCount()][mv.getBladesCount()];
        for (int i=0;i<cgaCayleyTable.getRow();i++){
            for (int j=0;j<cgaCayleyTable.getCol();j++){
